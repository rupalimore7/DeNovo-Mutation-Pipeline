...
open (FR, "$workdir/$famname/trio.$famname.$samname.mpileup.out.snp.vcf")or die "cannot open file";
open(my $outfile1, ">","$workdir/$famname/trio.$famname.$samname.mpileup.out.snp.vcf.filter.txt");
